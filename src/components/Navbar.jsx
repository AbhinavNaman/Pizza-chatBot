...
const Navbar = () => {
  return (
    <div className='flex justify-between p-4 items-center shadow-xl drop-shadow-lg' style={{}}>
      <div className='flex items-end gap-4'>
        <svg width="142" viewBox="0 0 142 31" xmlns="http://www.w3.org/2000/svg" role="img" aria-labelledby="logoTitle">
      ...
      <div>
        <Button  className="rounded-full bg-belden w-24">
            Login
        </Button>
      </div>
    </div>
